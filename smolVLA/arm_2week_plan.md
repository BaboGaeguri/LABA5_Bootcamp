...
| 질문 | 결론 | 근거 | 결론일 |
|------|------|------|--------|
| Ubuntu vs Windows? | **Ubuntu 필수** | lerobot Dynamixel USB 연결이 WSL2에서 불안정. natively Ubuntu 권장 | 2026-04-20 |
| Leader arm 새로 사야 하나? | **랩미팅 후 교수님께 주문 요청** | 아래 "단일 팔 → 양팔 전략" 참고 | 2026-04-20 |
| 자유도 낮추기? | | | |
| 양 팔이 가능한지? | | | |
...
### 학습 하드웨어
- 일단 dgx spark를 최대한 적극적으로 이용.
- 희승과 병목이 생기거나 문제가 생겼을 경우, 교수님 연구실 GPU를 학습에 이용.
